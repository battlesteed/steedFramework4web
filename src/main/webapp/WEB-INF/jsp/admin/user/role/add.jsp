...
<form target="navTab" method="post" action="<st:getCurrentUrl lastUrl="save.act" />" class="pageForm required-validate" onsubmit="return iframeCallback(this);">
	<fieldset>
		...
		<dl>
			<dt>角色名称:</dt>
			<dd><input id="name" class="required" name="name" type="text" /></dd>
		</dl>
		<dl>
			<dt></dt>
			<dd></dd>
...
<fieldset>
		...
		<dl class="nowrap">
			...
			<dd>
				...
				<%=
					JspMethod.traversePath_Power((List<Path_Power>)application.getAttribute("Path_PowerList"),null,new StringBuffer(),"powerSet")					
				%>
				</ul>
			</dd>
		</dl>
