...
<form target="navTab" method="post" action="<st:getCurrentUrl lastUrl="save.act" />" class="pageForm required-validate" onsubmit="return iframeCallback(this);">
	<fieldset>
		...
		<dl>
			<dt>标题:</dt>
			<dd><input class="required" name="title" type="text" /></dd>
		</dl>
		<dl>
			<dt>所属栏目:</dt>
			<dd>
	...
	<fieldset>
		...
		<dl class="nowrap">
			<dt>正文：</dt>
			<dd>
			<textarea style="width: 122%;height: 220px;" id="${requestScope.ueditorID }content" name="content" >${requestScope.email.content }</textarea>
			</dd>
		</dl>
	</fieldset>
	<div class="formBar">
