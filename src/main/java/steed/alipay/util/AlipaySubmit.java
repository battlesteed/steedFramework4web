...
import steed.alipay.sign.MD5;
import steed.alipay.util.httpClient.HttpProtocolHandler;
import steed.alipay.util.httpClient.HttpRequest;
import steed.alipay.util.httpClient.HttpResponse;
import steed.alipay.util.httpClient.HttpResultType;
...
public class AlipaySubmit {
	...
	public static String buildRequestMysign(Map<String, String> sPara) {
        ...
        String mysign = "";
    	mysign = MD5.sign(prestr, AESUtil.aesDecode(PropertyUtil.getConfig("alipay.key")), AlipayConfig.input_charset);
        return mysign;
    }
	...
	public static String query_timestamp() throws MalformedURLException,
        ...
        String strUrl = ALIPAY_GATEWAY_NEW + "service=query_timestamp&partner=" + AESUtil.aesDecode(PropertyUtil.getConfig("alipay.partner")) + "&_input_charset" +AlipayConfig.input_charset;
