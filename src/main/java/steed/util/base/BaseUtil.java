...
public class BaseUtil {
	private static final Gson gson = new GsonBuilder().disableHtmlEscaping().setDateFormat("yyyy-MM-dd HH:mm:ss").registerTypeAdapter(Date.class, new SmartDateJsonSerializer()).create();
