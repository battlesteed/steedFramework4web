...
<%@ page import="steed.alipay.config.*"%>
<%@ page import="steed.alipay.util.*"%>
...
<html>
	...
	<%
		...
		sParaTemp.put("notify_url", PathUtil.getBrowserPath("/alipay/wapPay/notify_url.act"));
		sParaTemp.put("return_url", PathUtil.getBrowserPath("/alipay/wapPay/return.act"));
